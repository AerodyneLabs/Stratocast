...
make_closeHandler = function(rl, next, parsed, lat, lng, timestamp) {
...
make_parser = function(j, fileName) {
...
make_parseRow = function(fileName) {
...
extractSounding = function(fileName, lat, lng, next) {};
