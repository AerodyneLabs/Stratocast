...
/**
 * Compute the air density represented by this observation.
 * 
 * @return {Number} Density in kg/m3
 */
AtmosphericObservation.prototype.getAirDensity = function() {
	return (this.pressure * 0.0289644) / (8.31432 * this.temperature);
};